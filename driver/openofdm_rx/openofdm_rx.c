...
static inline void OPENOFDM_RX_REG_LTF_ONE_write(u32 Data) {
	reg_write(OPENOFDM_RX_REG_LTF_ONE_ADDR, Data);
}
static inline void OPENOFDM_RX_REG_LTF_TWO_write(u32 Data) {
	reg_write(OPENOFDM_RX_REG_LTF_TWO_ADDR, Data);
}
...
static inline u32 hw_init(enum openofdm_rx_mode mode){
  ...
  //openofdm_rx_api->OPENOFDM_RX_REG_PHASE_OFFSET_ABS_TH_write(OPENOFDM_RX_PHASE_OFFSET_ABS_TH); // WE ELIMINATED THE WATCHDOG
  openofdm_rx_api->OPENOFDM_RX_REG_LTF_ONE_write(OPENOFDM_RX_LTF_ONE_VAL);
  openofdm_rx_api->OPENOFDM_RX_REG_LTF_TWO_write(OPENOFDM_RX_LTF_TWO_VAL);
...
static int dev_probe(struct platform_device *pdev)
{
	...
	openofdm_rx_api->OPENOFDM_RX_REG_LTF_ONE_write=OPENOFDM_RX_REG_LTF_ONE_write;
	openofdm_rx_api->OPENOFDM_RX_REG_LTF_TWO_write=OPENOFDM_RX_REG_LTF_TWO_write;
